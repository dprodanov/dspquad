 ...
 */
public class LogGamma implements QFunction {
	...
	final static double[] c =new double[] {
	...
	public static void main(String[] args) {
		...
		LogGamma g= new LogGamma();
		
		double ret=g.eval(0.5);
		System.out.println (" I_4="+ ret+"\t, "+ log(PI)/2.0);
		
		ret=g.eval(3.5);
		System.out.println (" I_4="+ ret+"\t, "+ log((15.0*sqrt(PI))/8.0));
		
		ret=g.eval(4.5);
		System.out.println (" I_4="+ ret+"\t, "+ log((105.0*sqrt(PI))/16.0));
	}
