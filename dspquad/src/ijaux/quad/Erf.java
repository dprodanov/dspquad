...
/**
 * @author prodanov
 * based on http://www.kurims.kyoto-u.ac.jp/~ooura/gamerf.html
 */
public class Erf implements QFunction {
	...
	public static void main(String[] args) {
		...
		System.out.println (" I_4="+ ret+"\t, "+0.5204998778130465);
		
		ret=g.eval(2.5);
		System.out.println (" I_4="+ ret+"\t, "+0.999593047982555);
		
		ret=g.eval(5);
		System.out.println (" I_4="+ ret+"\t, "+0.9999999999984626);
