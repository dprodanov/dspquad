...
import ijaux.quad.gbessel.GBessel2L;
import ijaux.quad.gbessel.GBesselK2;
import ijaux.quad.gbessel.GBesselK3;

public class UGBesselK3 extends GBesselK3 implements UIFunction {
	
	private String title= "GL_2(a,x)";
	DefaultXYDataset udata =new DefaultXYDataset();
	XYSeries series=null;

	public UGBesselK3(double a) {
		super(a);
		title= "GL_2("+a+",x)";
