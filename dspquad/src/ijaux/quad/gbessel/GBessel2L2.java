...
*/
public class GBessel2L2 implements QFunction {
	...
	private class KerF implements QFunction {
		...
		public double eval(double u) {
			...
			return  u*up*exp(-up)*(bk0) ;
		}

		@Override
		public String toString() {
			return " exp(-k^(2*a))* J_0 ( k r) * k^((2*a+1) ";
		}
	...
	public GBessel2L2(double aa) {
		a=aa;
		ga=gam.eval(1.0/a);
	}
	
	public GBessel2L2(double aa, double ttol) {
		a=aa;
		tol=ttol;
		ga=gam.eval(1.0/a);
	}
	...
	public static void main(String[] args) {
		...
		GBessel2L2 g= new GBessel2L2(1.0);
