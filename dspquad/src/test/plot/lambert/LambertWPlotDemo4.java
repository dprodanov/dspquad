...
public class LambertWPlotDemo4 {

	public LambertWPlotDemo4() {
...
public static void main(String[] args) {
	    ...
	    SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
	            ...
	            XYSeries ds1 = plotter.dataset(-0.4, 15, 300);
	            dataset.addSeries(ds1);
	            XYSeries ds2 = plotter2.dataset(-0.4, 15, 300);
