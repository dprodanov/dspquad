...
public class LambertWPlotDemo3 {

	public LambertWPlotDemo3() {
...
public static void main(String[] args) {
	    ...
	    SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
	            ...
	            XYSeries ds1 = plotter.dataset(-0.5, 1, 300);
	            dataset.addSeries(ds1);
	            XYSeries ds2 = plotter2.dataset(-0.5, 1, 300);
