...
import ijaux.quad.plot.UGBessel2;
 
 
public class GBessel2PlotDemo1 {
...
private static XYSeries datasetGauss( double x0, double xn, int npoints) {
	...
	XYSeries series=new XYSeries("((x^2-2)*%e^(-x^2/4))/4");
