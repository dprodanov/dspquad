...
public static void main(String[] args) {
    ...
    SwingUtilities.invokeLater(new Runnable() {
		...
		public void run() {
           ...
           XYSeries ds1 = dataset(1.0, -1.5, -3.0, 3.0, 101);
           dataset.addSeries(ds1);
           
           final XYSeriesCollection dataset2 = new XYSeriesCollection();
           
         XYSeries ds2 = dataset2(1.0, 1.5, -3.0, 3.0, 101);
...
private static XYSeries dataset2(double alpha, double beta, double x0, double xn, int npoints) {
