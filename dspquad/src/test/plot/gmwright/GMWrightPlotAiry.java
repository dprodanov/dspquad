...
public static void main(String[] args) {
    ...
    SwingUtilities.invokeLater(new Runnable() {
		...
		public void run() {
           ...
           XYSeries ds1 = dataset(-0.5, 0.5, 0, 10.0, 50);
           dataset.addSeries(ds1);
           XYSeries ds2 = dataset(-0.5, 1.0, 0, 10.0, 50);
           dataset.addSeries(ds2);
           XYSeries ds3 = dataset(-0.33333, 0.66667, 0, 10.0, 100);
           dataset.addSeries(ds3);
           XYSeries ds4 = dataset(-0.33333, 1.0, 0, 10.0, 100);
           dataset.addSeries(ds4);
           XYSeries ds5 = dataset(-0.66667, 0.33333, 0, 10.0, 100);
           dataset.addSeries(ds5);
           XYSeries ds6 = dataset(-0.66667, 1.0, 0, 10.0, 100);
